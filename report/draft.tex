...
\begin{table}[h!]
    ...
    \begin{tabular}{llcc}
        ...
        \midrule
        Brewster's Angle & $\theta_p$ & $67.5 \pm 1.5$ & \si{\degree} \\
        Refractive Index (Acrylic) & $n_2$ & $2.41 \pm 0.18$ & Unitless \\
        Perpendicular Reflectance (at \SI{30}{\degree}) & $R_{\perp}$ & $0.214 \pm 0.016$ & Unitless \\
        Parallel Reflectance (at \SI{30}{\degree}) & $R_{||}$ & $0.131 \pm 0.010$ & Unitless \\
        \bottomrule
    \end{tabular}
    \caption{Summary of Key Results from Brewster's Angle Experiment and Associated Uncertainties.}
\end{table}
\section{Conclusion}
